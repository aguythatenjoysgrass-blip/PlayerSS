...
local RayfieldLibrary = {
	...
	Theme = {
		Default = {
			TextColor = Color3.fromRGB(122, 240, 240),

			Background = Color3.fromRGB(122, 0, 0),
			Topbar = Color3.fromRGB(122, 0, 0),
			Shadow = Color3.fromRGB(20, 20, 20),

			NotificationBackground = Color3.fromRGB(122, 0, 0),
			NotificationActionsBackground = Color3.fromRGB(122, 0, 0),

			TabBackground = Color3.fromRGB(122, 0, 0),
			TabStroke = Color3.fromRGB(255, 0, 0),
			TabBackgroundSelected = Color3.fromRGB(230, 0, 0),
			TabTextColor = Color3.fromRGB(255, 255, 255),
			SelectedTabTextColor = Color3.fromRGB(255, 255, 255),

			ElementBackground = Color3.fromRGB(122, 0, 0),
			ElementBackgroundHover = Color3.fromRGB(122, 0, 0),
			SecondaryElementBackground = Color3.fromRGB(122, 0, 0),
			ElementStroke = Color3.fromRGB(255, 0, 0),
			SecondaryElementStroke = Color3.fromRGB(255, 0, 0),

			SliderBackground = Color3.fromRGB(122, 0, 0),
			SliderProgress = Color3.fromRGB(255, 0, 0),
			SliderStroke = Color3.fromRGB(230, 0, 0),
			...
			DropdownSelected = Color3.fromRGB(255, 40, 40),
			DropdownUnselected = Color3.fromRGB(122, 30, 30),

			InputBackground = Color3.fromRGB(255, 0, 0),
			InputStroke = Color3.fromRGB(255, 65, 65),
